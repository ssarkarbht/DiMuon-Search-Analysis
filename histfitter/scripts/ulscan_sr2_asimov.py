...
##########################
anaName = signalR+"_ULScan"
dirName = signalR+"_s+b"
if not os.path.exists(f"ul_scan/{dirName}"):
	os.makedirs(f"ul_scan/{dirName}")
...
configMgr.outputFileName = f"ul_scan/{dirName}/{configMgr.analysisName}s_Output.root"
